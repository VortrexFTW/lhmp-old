...
namespace MafiaSDK
{
	...
	public:
		...
		void C_Camera::SetCamera(unsigned long I3D_Camera)
		{
		...
		void C_Camera::SetPlayer(C_Human* human)
		{
		...
		void C_Camera::SetCar(C_Car* car)
		{
		...
		void C_Camera::Link(unsigned long I3D_frame)
		{
		...
		void C_Camera::SetSwing(BOOL enable, float angle, unsigned long I3D_frame)
		{
		...
		void C_Camera::LookAround(int val)
		{
		...
		void C_Camera::LookFromEyes(void)
		{
		...
		void C_Camera::SetMode(BOOL enabled, int typeval)
		{
		...
		void C_Camera::LezeDoToyoty(BOOL leze)
		{
		...
		void C_Camera::FreeLook(BOOL unk1, BOOL unk2)
		{
		...
		void C_Camera::FreeLookBase(float ohnisko, float rychlost, Vector3D & vPozice, Vector3D &vRotace1, Vector3D &vRotace2)
		{
		...
		void C_Camera::LockAt(Vector3D const &vPos, Vector3D const &vRot)
		{
		...
		void C_Camera::CumNane(C_Human* C_humanOne, C_Human* C_humanTwo)
		{
		...
		void C_Camera::PopMode(BOOL bPop)
		{
		...
		void C_Camera::DialogStart(C_Human* human, int sholder)
		{
		...
		void C_Camera::DialogLook(C_Human* humanOne,C_Human* humanTwo)
		{
		...
		void C_Camera::AddRaceCamera(unsigned long G_RaceCamera)
		{
		...
		void C_Camera::RemoveRaceCamera(unsigned long G_RaceCamera)
		{
		...
		void C_Camera::SetLookTo(Vector3D const &vVec, unsigned long I3D_Frame)
		{
		...
		void C_Camera::SetSniperFov(float fFov)
		{
		...
		void C_Camera::SetSniperMode(BOOL bEnabled)
		{
